    ...
    <div class="non-top-nav">
        ...
        <div class="main">
            <div class="main-container">
                <div class="query-box">
                    <form accept-charset="UTF-8" action="${pageContext.request.contextPath}/user" class="query-form clearfix">
                        ...
                        <c:forEach var="user" items="<%=users%>">
                            <tr>
                                ...
                                <td style="width: 149px">
                                    <a href="${pageContext.request.contextPath}/user?method=delete&id=${user.id}">
                                        <button class="btn btn-danger btn-sm">删除</button>
                                    </a>
                                    <a href="${pageContext.request.contextPath}/router?page=admin_user_update&id=${user.id}">
