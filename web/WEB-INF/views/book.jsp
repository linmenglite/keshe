        ...
        <div class="main">
            <div class="book-page">
                <div class="query-form">
                    <form accept-charset="UTF-8" action="${pageContext.request.contextPath}/book" method="post"
                          class="clearfix"
                    ...
                    <table class="table table-bordered table-hover" style="margin: 0 auto">
                        ...
                        <c:forEach var="book" items="<%=books%>">
                            <tr>
                                ...
                                <td>${book.info}</td>
                                <td>${book.pricing}</td>
                                <td style="width: 54px">${book.isBorrowed ? "是" : "否"}</td>
                                <td style="width: 120px" class="d-flex">
                                    <div>
                                        <a href="${pageContext.request.contextPath}/book?method=borrow&id=${book.id}">
                                            <button class="btn btn-primary btn-sm">借阅</button>
                                        </a>
                                    </div>
                                    <div style="margin-left: 6px">
                                        <a href="${pageContext.request.contextPath}/book?method=return&id=${book.id}">
